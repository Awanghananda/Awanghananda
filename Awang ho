...
<div><blockquote id='bq'><img id="foto1" src=""/><img id="foto2" src=""/><img id="foto3" src=""/><img id="foto4" src=""/><img id="foto5" src=""/><img id="foto6" src=""/><p id="katakata"></p><p id="katabawah"></p><p id="akhiran" onClick="menuju();">[ Kirim WhatsApp &#128157; ]</p></blockquote></div>

<div id="contTom" style="display:none;"><a id="By" class='button' onClick="terima()"></i>Lanjut</a><b id='buttonv2'></b><a id="Bn" class='button' onClick="tolak()"></i>Engga</a></div>
</div>
...
<script>
  ...
  function loadfoto() {document.getElementById('foto1').src = gambar1;document.getElementById('foto2').src = gambar2;document.getElementById('foto3').src = gambar3;document.getElementById('foto4').src = gambar4;document.getElementById('foto5').src = gambar5;document.getElementById('foto6').src = gambar6;}
...
<script type="text/javascript">
 ...
 async function apapun() {
   ...
   wallpaper.src = "https://i.postimg.cc/wMSSWX1B/IMG-20220211-161601-480.jpg";
   ...
   katanya = "Ayaaanggg rindu ga? "; emotsenyum = "&#128577;";
   ...
   linklagu = 'https://Kamu.feeldream.repl.co/faudio.mp3';
